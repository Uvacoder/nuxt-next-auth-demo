    ...
    <header>
        ...
        <nav>
            <ul class="navItems">
                ...
                <li class="navItem"><nuxt-link to="/client">Client</nuxt-link></li>
                <li class="navItem"><nuxt-link to="/server">Server</nuxt-link></li>
                <li class="navItem"><nuxt-link to="/protected">Protected</nuxt-link></li>
            </ul>
        </nav>
    </header>
</template>
...
import { useSession, signIn, signOut } from 'nuxt-next-auth';
